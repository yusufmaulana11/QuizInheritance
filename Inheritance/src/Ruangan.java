...
//agar ruangan dan player bisa bersatu, jadi beberapa variable dan fungsi di Player di turunkan ke Ruangan

public class Ruangan extends Player{
    ...
    public Ruangan() {
        ...
        objPintu = new Pintu("Red Door");
        objNPC = new NPC("Guardian");
